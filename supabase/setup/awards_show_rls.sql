...
DROP POLICY IF EXISTS "Authenticated can select runtime" ON public.awards_show_runtime;
...
DROP POLICY IF EXISTS "Admins can modify runtime" ON public.awards_show_runtime;
...
DROP POLICY IF EXISTS "Authenticated can select reactions" ON public.awards_show_reactions;
...
DROP POLICY IF EXISTS "Authenticated can insert reactions" ON public.awards_show_reactions;
...
DROP POLICY IF EXISTS "Admins can modify reactions" ON public.awards_show_reactions;
